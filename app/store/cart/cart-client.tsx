...
type Tenant = { name: string; freeDeliveryAbove: number | null; shippingFee: number }
...
function TrustBadges({ tenant }: { tenant: Tenant }) {
  return (
...
export function CartClient({ tenant }: { tenant: Tenant }) {
